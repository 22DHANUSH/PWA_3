...
import { Form, Input, Button, Typography, Row, Col, message, Select } from "antd";
                  ...
                  <Input.Group compact>
                    ...
                    >
                      <Select size="large" style={{ width: '30%' }}>
                        <Select.Option value="+91">IN +91</Select.Option>
                        <Select.Option value="+1">US +1</Select.Option>
                        <Select.Option value="+44">GB +44</Select.Option>
                        <Select.Option value="+61">AU +61</Select.Option>
                        <Select.Option value="+81">JP +81</Select.Option>
                      </Select>
                    </Form.Item>
                      ...
                      rules={[
                        { required: true, message: "Phone number is required" },
                        {
                          validator: (_, value) =>
                            /^\d{10,15}$/.test(value)
                              ? Promise.resolve()
                              : Promise.reject("Phone number must be 10 to 15 digits"),
                        },
                      ]}
                    >
                      <Input size="large" style={{ width: '70%' }} placeholder="Mobile Number" />
                    </Form.Item>
                  </Input.Group>
                </Form.Item>
              </Col>
